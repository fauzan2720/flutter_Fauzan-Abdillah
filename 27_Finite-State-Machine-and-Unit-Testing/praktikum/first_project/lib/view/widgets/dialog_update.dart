      ...
      child: AlertDialog(
        ...
        actions: <Widget>[
          FozFormInput(
            ...
            validator: (value) =>
                context.read<ContactProvider>().nameValidation(value!),
          ),
          16.0.height,
          FozFormInput(
            label: 'Nomor',
            ...
            validator: (value) =>
                context.read<ContactProvider>().phoneValidation(value!),
          ),
          16.0.height,
          Align(
            ...
            child: FozFormButton(
              ...
              onPressed: () {
                ...
                if (form.validate()) {
                  context.read<ContactProvider>().updateContact(ContactQuery(
